            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#">  <span class="fa fa-bell"></span>  Learn code with Punit <span class="sr-only">(current)</span></a>
                    </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container text-center">
                            <img src="Pics/<%=user.getProfile()%>" class="imf-fluid" style="border-radius: 50%;max-width: 150px;">
                            <br>
